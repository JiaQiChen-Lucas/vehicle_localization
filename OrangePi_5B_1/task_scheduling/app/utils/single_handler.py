...
def single_handler_start(
    ...
    manager.add_stream("stream1", is_circular=True, bytetrack_frame_rate=5, image_time_save_path=image_time_file_path)
    manager.add_stream("stream2", is_circular=True, bytetrack_frame_rate=5, image_time_save_path=image_time_file_path)
    manager.add_stream("stream3", is_circular=True, bytetrack_frame_rate=5, image_time_save_path=image_time_file_path)
    manager.add_stream("stream4", is_circular=True, bytetrack_frame_rate=5, image_time_save_path=image_time_file_path)
